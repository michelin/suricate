...
export class WidgetService extends AbstractHttpService  {
  ...
  getCategories(): Observable<Category[]> {
    return this.httpClient.get<Category[]>(`${AbstractHttpService.BASE_API_URL}/${AbstractHttpService.WIDGETS_URL}/categories`);
  }
  ...
  getWidgetsByCategoryId(categoryId: number): Observable<Widget[]> {
    return this.httpClient.get<Widget[]>(`${AbstractHttpService.BASE_API_URL}/${AbstractHttpService.WIDGETS_URL}/category/${categoryId}`);
  }
}
