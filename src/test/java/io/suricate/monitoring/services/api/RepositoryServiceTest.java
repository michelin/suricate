...
class RepositoryServiceTest {
    ...
    void shouldGetAll() {
        ...
        verify(repositoryRepository, times(1)).findAll(any(RepositorySearchSpecification.class), any(Pageable.class));
    }
    ...
    void shouldFindAllByEnabledOrderByPriorityDescCreatedDateAsc() {
        ...
        verify(repositoryRepository, times(1)).findAllByEnabledOrderByPriorityDescCreatedDateAsc(true);
    }
    ...
    void shouldGetOneById() {
        ...
        verify(repositoryRepository, times(1)).findById(1L);
    }
    ...
    void shouldFindByName() {
        ...
        verify(repositoryRepository, times(1)).findByName("name");
    }
    ...
    void shouldExistsById() {
        ...
        verify(repositoryRepository, times(1)).existsById(1L);
    }
    ...
    void shouldAddOrUpdateRepositories() {
        ...
        when(repositoryRepository.saveAll(any())).thenReturn(repositories);

        repositoryService.addOrUpdateRepositories(Collections.singletonList(repository));

        verify(repositoryRepository, times(1)).saveAll(repositories);
    }
}
