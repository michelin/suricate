// SURI_TITLE::Widget title::STRING::Release X.X
// SURI_JQL_ALL::Jira JQL query to count all issue::STRING::fixVersion = "MCP 1.1" AND project = MTDI
// SURI_JQL_CLOSED::Jira JQL query to count all closed issue::STRING::fixVersion = "MCP 1.1" AND project = MTDI and status in (3_Closed, Done, "Done Done")
//
function run (){
    var data = {};
