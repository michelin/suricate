...
@NgModule({
  imports: [CommonModule, LayoutModule, SharedModule, RouterModule.forChild(widgetConfigurationRoute)],
  declarations: [WidgetConfigurationListComponent, WidgetConfigurationEditComponent]
})
