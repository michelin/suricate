...
export class FormService {
  ...
  /**
   * Is the field a checkbox or not
   * @param formField The form field to check
   */
  public isCheckbox(formField: FormField): boolean {
    return formField.type === DataTypeEnum.BOOLEAN;
  }

  /**
   * Is the field a color picker or not
   * @param formField The form field to check
   */
  public isColorPicker(formField: FormField): boolean {
    return formField.type === DataTypeEnum.COLOR_PICKER;
  }

  /**
   * Is the field a file input or not
   * @param formField The form field to check
   */
  public isFile(formField: FormField): boolean {
    return formField.type === DataTypeEnum.FILE;
  }

  /**
   * Is the field a mosaic or not
   * @param formField The form field to check
   */
  public isMosaic(formField: FormField): boolean {
    return formField.type === DataTypeEnum.MOSAIC;
  }
}
