...
@Component({
	...
	imports: [NgClass, Spinner, WidgetHtmlDirective, MatIcon, MatTooltip, SafeHtmlPipe, TranslatePipe]
})
export class DashboardScreenWidget implements OnInit, OnDestroy {
