...
import { TvManagementDialog } from './tv-management-dialog';

describe('TvManagementDialog', () => {
	let component: TvManagementDialog;
	let fixture: ComponentFixture<TvManagementDialog>;

	beforeEach(async () => {
		await TestBed.configureTestingModule({
			imports: [TvManagementDialog],
			providers: [
		...
		fixture = TestBed.createComponent(TvManagementDialog);
