...
public class WidgetController {
    ...
    public Page<WidgetResponseDto> getWidgets(
            @Parameter(name = "search", description = "Search keyword")
                    @RequestParam(value = "search", required = false)
                    String search,
            @Parameter(hidden = true) Pageable pageable) {
        return widgetService.getAll(search, pageable).map(widgetMapper::toWidgetWithoutCategoryParametersDto);
    }
    ...
    public ResponseEntity<WidgetResponseDto> getOneById(
        ...
        return ResponseEntity.ok().contentType(MediaType.APPLICATION_JSON).body(widgetMapper.toWidgetDto(widget.get()));
    }
    ...
    public ResponseEntity<Void> updateWidget(
            ...
            @Parameter(name = "widgetRequestDto", description = "The widget with modifications", required = true)
                    @RequestBody
                    WidgetRequestDto widgetRequestDto) {
