...
public class CategoryParametersController {
    ...
    public Page<CategoryParameterResponseDto> getAll(
    ...
    public ResponseEntity<CategoryParameterResponseDto> getOneByKey(
            @Parameter(name = "key", description = "The configuration key", required = true) @PathVariable("key")
                    final String key) {
    ...
    public ResponseEntity<Void> updateOneByKey(
            ...
            @Parameter(name = "configurationResponseDto", description = "The configuration updated", required = true)
                    @RequestBody
                    final WidgetConfigurationRequestDto widgetConfigurationRequestDto) {
        Optional<CategoryParameter> configurationOptional = categoryParametersService.getOneByKey(key);
        ...
        categoryParametersService.updateConfiguration(
                configurationOptional.get(), widgetConfigurationRequestDto.getValue());
