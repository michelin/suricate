...
public class Oauth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    /**
     * Determine the host to redirect after being successfully authenticated. First, try to get the host from the HTTP
     * cookie attached on the IDP response. If empty, try to get the host from the referer. If still empty, get a
     * default host. Build a JWT token and add it as a parameter to the response
     *
     * @param request The request which is the response of the IDP
     * @param response The response to send to the host that authenticated successfully
     * @param authentication The authentication data
    ...
    protected String determineTargetUrl(
        ...
        OAuth2AuthorizedClient authorizedClient = authorizedClientRepository.loadAuthorizedClient(
                auth.getAuthorizedClientRegistrationId(), authentication, request);

        log.debug(
                "Access token generated by {}. Self-generated JWT token will be used instead.",
