...
public abstract class ProjectMapper {
    ...
    @Mapping(target = "screenshotToken", expression = "java( project.getScreenshot() != null ? com.michelin.suricate.utils.IdUtils.encrypt(project.getScreenshot().getId()) : null )")
