...
public interface ProjectWidgetRepository
     ...
     */
    @NotNull @EntityGraph(attributePaths = {"projectGrid.project.users.roles", "widget.widgetParams.possibleValuesMap"})
    ...
    void updateRowAndColAndWidthAndHeightById(
            @Param("row") int row,
            @Param("col") int col,
    ...
    void updateSuccessExecution(
            @Param("lastExecutionDate") Date executionDate,
    ...
    void updateLastExecutionDateAndStateAndLog(
            @Param("lastExecutionDate") Date date,
            @Param("log") String log,
            @Param("id") Long id,
            @Param("state") WidgetStateEnum widgetState);
}
