...
- **Suricate v2.8.0 and Later:** Requires [GraalVM 17](https://www.graalvm.org/) with
  the [JavaScript module installed](https://www.graalvm.org/22.3/docs/getting-started/#run-javascript-and-nodejs).
